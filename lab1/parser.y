...
//补充数组声明
ArrayDec: LB INDEX RB {$$=mknode(1,ARRAY_DEC,yylineno,$2);strcpy($$->type_id,"ARRAY_DEC");}
          | LB INDEX RB ArrayDec {$$=mknode(2,ARRAY_DEC,yylineno,$2,$4);strcpy($$->type_id,"ARRAY_DEC");}
...
Stmt:   Exp SEMI    {$$=mknode(1,EXP_STMT,yylineno,$1);}
	  ...
	  | FOR LP FORDEC RP Stmt {$$=mknode(2,FOR_NODE,yylineno,$3,$5);}
